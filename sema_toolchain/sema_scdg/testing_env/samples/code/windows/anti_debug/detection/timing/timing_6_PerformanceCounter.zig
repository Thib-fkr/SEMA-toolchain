// This sample uses the QueryPerformanceCounter function to evaluate the time
...
pub fn main() void {
    const timing1 = win.QueryPerformanceCounter();
    ...
    const timing2 = win.QueryPerformanceCounter();
